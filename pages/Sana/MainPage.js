  ...
  const products = [
    {
      ...
      image: "/hairCare.webp", // Replace with the actual path
    },
    {
      title: "Skincare",
    ...
    },
    {
      ...
      image: "/makeup.webp", // Replace with the actual path
    },
    {
      title: "Sunglasses",
      description: "Stylish and protective sunglasses for a sunny day.",
      image: "/sunglass.webp", // Replace with the actual path
    },
  ];
        ...
        <div className={styles.productList}>
          {products.map((product, index) => (
            <div className={styles.card} key={index}>
              ...
              <Link
                href="/Sana/ExclusiveCollections#start"
                to="/ExclusiveCollections#start"
      ...
      <div className={styles.contactusDiv}>
        ...
        <div className={styles.contactusDivText}>
          <div>
            ...
            <p>
              Enhance your natural beauty with a personalized makeup experience
              tailored to your style—book your session today!
            </p>
          </div>
          <div>
            <ul
            ...
            >
              <li class="icon facebook">
                <span class="tooltip"   onClick={(e) => {
      e.preventDefault();
      console.log("df") // Prevent default behavior
      window.open("https://www.facebook.com/saanasworld/", "_blank");
    }}>Facebook</span>
                <svg
                  viewBox="0 0 320 512"
                  height="1.2em"
